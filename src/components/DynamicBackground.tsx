    ...
    return (
        <div className="fixed inset-0 -z-10 bg-background overflow-hidden pointer-events-none">
            ...
            <motion.div
                ...
                className="absolute -top-[10%] -left-[10%] h-[60%] w-[60%] rounded-full bg-primary/10 blur-[100px]"
            />
            ...
            <motion.div
                ...
                style={{ willChange: "transform, opacity" }}
                className="absolute bottom-[0%] -right-[10%] h-[50%] w-[50%] rounded-full bg-secondary/10 blur-[100px]"
            />
            ...
            <motion.div
                ...
                className="absolute left-0 right-0 h-[400px] bg-gradient-to-b from-transparent via-primary/5 to-transparent pointer-events-none opacity-30"
            />
        </div>
    );
};
