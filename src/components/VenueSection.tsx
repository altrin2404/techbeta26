                    ...
                    >
                        ...
                        >
                            <div className="flex items-center gap-3 mb-4">
                                <MapPin className="text-primary h-6 w-6 group-hover:scale-110 transition-transform" />
                        ...
                        >
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center pb-8 mt-12">
                                ...
                                <motion.div
                                    ...
                                    className="glass-card rounded-3xl overflow-hidden border border-black/5 dark:border-white/10 p-2 shadow-lg h-[400px]"
                                >
                                    <iframe
